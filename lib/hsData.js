...
var HsFactoryBase = (function () {
    function HsFactoryBase(url, reqData) {
        _classCallCheck(this, HsFactoryBase);

        this.url = url;
        this.reqData = reqData;
        this.hsInstance = new _HsInstanceJs2['default'](url, reqData);
    }

    _createClass(HsFactoryBase, [{
        key: 'onDataReady',
...
var WizardFactory = (function (_HsFactoryBase) {
    function WizardFactory(reqData) {
        _classCallCheck(this, WizardFactory);

        _get(Object.getPrototypeOf(WizardFactory.prototype), 'constructor', this).call(this, apiUrlMap.wizard, reqData);
    }

    _inherits(WizardFactory, _HsFactoryBase);

    return WizardFactory;
})(HsFactoryBase);

var KlineFactory = (function (_HsFactoryBase2) {
    function KlineFactory(reqData) {
        _classCallCheck(this, KlineFactory);

        _get(Object.getPrototypeOf(KlineFactory.prototype), 'constructor', this).call(this, apiUrlMap.kline, reqData);
    }

    _inherits(KlineFactory, _HsFactoryBase2);
